...
import { FaYoutube, FaGithub, FaLinkedin, FaMedium, FaHome, FaUser, FaTools, FaCode, FaCertificate, FaEnvelope } from 'react-icons/fa';

import newProfilePic from '../assets/WhatsApp Image 2025-09-07 at 12.14.27_c62ea22e.jpg'; 

const HeroSection = () => {
  return (
    <div className="bg-slate-950 text-white min-h-screen flex items-center justify-center px-4 md:px-16">
      
      {/* Fixed Icons on the Right */}
      <div className="fixed right-0 top-1/2 -translate-y-1/2 p-4 z-50 flex flex-col items-center space-y-8">
